...
<div class="navbar-header d-xl-block d-none">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/blog">Blo List</a>
        </li>
     </ul>
</div>
      <br/><br/><br/>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-12">
      ...
      <div class="card-body">
      <form class="form form-horizontal" name="PostForm" action="/add-post" method="POST" enctype="multipart/form-data"  onsubmit="return validateForm()">
                @csrf
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
