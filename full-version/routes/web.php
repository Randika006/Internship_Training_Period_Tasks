...
// Main Page Route of Blog Page
Route::get('/', [HomeController::class, 'home_page'])->name('home-page');

//Login Page Route of Blog Page
Route::get('/Login', [AdminAuthenticationController::class, 'admin_login_basic'])->name('admin-auth-login-basic');
Route::post('/Login', [AdminAuthenticationController::class, 'LoginSystem']);


//Admin Dashboard Page Route
Route::get('/AdminDash', [AdminDashboardController::class, 'AdmindashboardAnalytics'])->name('admin-dashboard-analytics');



//Post Upload

//Route::get('/AddPost', [ PostController::class,'PostUpload'])-name('post-upload');
Route::get('/post', [ PostController::class,'PostUpload']);
Route::post('/add-post',[ PostController::class,'store']);

//Route::middleware('auth')->post('/add-post',[ PostController::class,'store']);

//Blog-list-display-all
Route::get('/blog-list', [ BloglistController::class,'show']);
...
//Reply comment
//Route::get('/reply',[CommentController::class,'manageComment']);
