      ...
      <div class="card">
        <div class="card-header">
         ...
         @if(session('status'))
          ...
          @endif
        <br/>
        <p style="position: relative;left:120px;font-size:18px;font-weight:bold;">Upate posts for the blog</p>
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="title" value ="{{$blog_post->title}}"  class="form-control" name="title" placeholder="Title" style="position:relative;right:122px;width:459px;"/>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-6 mb-1">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="file"  name="photo"  value ="{{$blog_post->photo}}"   class="form-control" style="position:relative;right:122px;width:460px;">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="summary" value ="{{$blog_post->summary}}" class="form-control" name="summary" placeholder="summary" style="position: relative;right:122px;width:460px;" />
                  </div>
                </div>
              </div>
              <div class="col-12">
